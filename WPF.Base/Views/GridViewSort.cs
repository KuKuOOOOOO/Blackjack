namespace WPF.Views
{
  ...
  /// <summary>
  /// http://tomlev2.wordpress.com/2009/08/04/wpf-automatically-sort-a-gridview-continued/
  /// </summary>
  public static class GridViewSort
  {
    ...
    private class SortGlyphAdorner : Adorner
    {
      ...
      {
        double x1 = this._columnHeader.ActualWidth - 13;
        double x2 = x1 + 10;
        double x3 = x1 + 5;
        double y1 = this._columnHeader.ActualHeight / 2 - 3;
        double y2 = y1 + 5;
      ...
      protected override void OnRender(DrawingContext drawingContext)
      {
        ...
        {
          double x = this._columnHeader.ActualWidth - 13;
          double y = this._columnHeader.ActualHeight / 2 - 5;
